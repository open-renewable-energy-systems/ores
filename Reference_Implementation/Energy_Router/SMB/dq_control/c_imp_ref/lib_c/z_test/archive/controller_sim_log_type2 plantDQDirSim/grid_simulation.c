...
void simulate_system(SystemParams* params, SimulationData* data) {
    ...
    for (int n = 0; n < data->length - 1; n++) {
       ...
       ///////////////////////////////////////////////////////////////////////
        ...
        PlantSimulator_Update(&plant_state, &plant_params,
                                data->v_smb_d[n], data->v_smb_q[n],
                                data->v_grid_d[n], data->v_grid_q[n]); // d-q grid voltages

        data->i_alpha[n+1] = plant_state.i_alpha;
        data->i_meas[n+1] = plant_state.i_alpha;
        data->id[n+1] = plant_state.id;
        data->iq[n+1] = plant_state.iq;
        ///////////////////// 模拟结束/////////////////////////////////////
        ...
        data->i_raw_d[n+1] = plant_state.id;
        data->i_raw_q[n+1] = plant_state.iq;
        ///////////////////// 模拟结束/////////////////////////////////////
    }
